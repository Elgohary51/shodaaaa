...
var Particle = (function() {
    function Particle() {
        ...
        this.age = 0;
        this.color = Math.random() > 0.5 ? settings.colors.primary : settings.colors.secondary;
    }
...
/*
 * Putting it all together with enhanced features
 */
(function(canvas) {
    ...
    // Enhanced particle image with gradient
    var image = (function() {
        ...
        gradient.addColorStop(0.5, settings.colors.accent);
    ...
    function render() {
        ...
        var amount = particleRate * deltaTime * 1.5;
